...
knowledge of the field, perhaps create an enum set.
      """
        ...
        #self.highDateEpoch = int(datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S %Z')) * self.millisAdj
        self.highDateEpoch = int(time.mktime(datetime.datetime.now().timetuple())) * self.millisAdj
    ...
    def str2Epoch(self, str):
        ...
        return int(time.mktime(datetime.datetime.strptime(str, "%Y%m%d").timetuple())) * self.millisAdj
